...
<div class= "portada"><h2><br>Cultura a solo un   <strong>click</strong><br></h2>
  ...
  <br>
    ...
    <form action="">
       ...
       <img src="../img/c2.jpg" class="image-select">
    ...
    <div class="shape"></div>
    <h1> Galeria de cultura urbana</h1>
    <!Para crear diferentes figuras, para almacenar imagenes y texto >
    <div class="container-gallery">
        <div class="gallery">
            <!Crear una figura>
            <!figure contiene la imagen>
                <figure><h1>Baile</h1><img src="../img/c1.jpg"></figure>
                <figure><h1>Deporte</h1><img src="../img/c2.jpg"></figure>
                <figure><h1>Arte urbano</h1><img src="../img/c3.jpg"></figure>
                <figure><h1>Museos</h1><img src="../img/c4.jpg"></figure>
                <figure><h1>Graffiti</h1><img src="../img/c5.jpg"></figure>
                <figure><h1>Imagenes</h1><img src="../img/c6.jpg"></figure>
                
            </div>
            <P>La cultura urbana se podría definir como aquella cultura que engloba todos aquellos movimientos, expresiones o actitudes de determinados grupos que han surgido al amparo de los nuevos tiempos y las ciudades.</p>
            <BR>
            <P>La cultura urbana se deja ver en cualquier ámbito de la vida y la sociedad. La música, la cultura, la forma de pensar o de vestir, etc. Dentro de esta cultura urbana podríamos hablar de diferentes tribus urbanas, agrupaciones de gente que se mueve por unos mismos ideales, ya sean artísticos, políticos o estilísticos, o incluso por grupos de edad o sexo.</P>
