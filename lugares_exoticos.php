...
<div class= "portada"><h2><br>Cultura a solo un   <strong>click</strong><br></h2>
  ...
  <br>
    ...
    <form action="">
       ...
       <img src="../img/l2.jpg" class="image-select">
    ...
    <div class="shape"></div>
    <h1> Galeria de lugares exoticos </h1>
    <!Para crear diferentes figuras, para almacenar imagenes y texto >
    <div class="container-gallery">
        <div class="gallery">
            <!Crear una figura>
            <!figure contiene la imagen>
                <figure><h1>islas Marietas</h1><img src="../img/l1.jpg"></figure>
                <figure><h1>Rio de colores</h1><img src="../img/l2.jpg"></figure>
                <figure><h1>Grecia</h1><img src="../img/l3.jpg"></figure>
                <figure><h1>Montaña de colores</h1><img src="../img/l4.jpg"></figure>
                <figure><h1>Tailandia</h1><img src="../img/l5.jpg"></figure>
                <figure><h1>Paris</h1><img src="../img/l6.jpg"></figure>
               
            </div>
            <br>
            <p>Hay cientos de lugares en el mundo que parecen irreales y no puedes creer que existen, algunos por suerte los descubrieron y podemos ir a conocerlos para cautivarnos con las maravillas que nos ofrecen.</p>
            <br>
           <p> Historias, colores, climas, y elementos naturales diferentes, cada uno de estos lugares que les presentaremos a continuación guardan un atractivo y belleza única que te dejarán con las pupilas súper dilatadas.</p>
